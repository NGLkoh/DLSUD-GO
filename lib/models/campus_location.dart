...
class CampusLocation {
  ...
  static List<CampusLocation> get allLocations => [
    ...
    CampusLocation(
      ...
      section: CampusSection.east,
      latitude: 0.0, longitude: 0.0, icon: Icons.nature,
    ),
    CampusLocation(
      ...
      section: CampusSection.east,
      latitude: 0.0, longitude: 0.0, icon: Icons.museum,
    ),
    CampusLocation(
      id: 'cafe_museo',
      name: 'Cafe Museo',
    ...
    CampusLocation(
      ...
      section: CampusSection.east,
      latitude: 0.0, longitude: 0.0, icon: Icons.crop_square,
    ),
    CampusLocation(
      id: 'hotel_rafael',
    ...
    CampusLocation(
      ...
      description: 'Theater',
      section: CampusSection.east,
      latitude: 0.0, longitude: 0.0, icon: Icons.theater_comedy,
    ),
    CampusLocation(
      id: 'porteria_benildo',
    ...
    CampusLocation(
      ...
      section: CampusSection.east,
      latitude: 0.0, longitude: 0.0, icon: Icons.park,
    ),
    CampusLocation(
      id: 'lcdc',
    ...
    CampusLocation(
      ...
      description: 'Bridge',
      section: CampusSection.east,
      latitude: 0.0, longitude: 0.0, icon: Icons.landscape,
    ),
    CampusLocation(
      id: 'dormitories',
    ...
    CampusLocation(
      ...
      section: CampusSection.east,
      latitude: 0.0, longitude: 0.0, icon: Icons.book,
    ),
    CampusLocation(
      id: 'pgh',
      ...
      section: CampusSection.east,
      latitude: 0.0, longitude: 0.0, icon: Icons.military_tech,
    ),
    CampusLocation(
      id: 'pch',
    ...
    CampusLocation(
      ...
      section: CampusSection.east,
      latitude: 0.0, longitude: 0.0, icon: Icons.menu_book,
    ),
    CampusLocation(
      id: 'university_lake',
      ...
      section: CampusSection.east,
      latitude: 0.0, longitude: 0.0, icon: Icons.water,
    ),
    ...
    CampusLocation(
      ...
      section: CampusSection.west,
      latitude: 0.0, longitude: 0.0, icon: Icons.eco,
    ),
    CampusLocation(
      id: 'cth_tirona',
    ...
    CampusLocation(
      ...
      section: CampusSection.west,
      latitude: 0.0, longitude: 0.0, icon: Icons.school,
    ),
    CampusLocation(
      id: 'kabalikat',
      ...
      section: CampusSection.west,
      latitude: 0.0, longitude: 0.0, icon: Icons.group,
    ),
    CampusLocation(
      id: 'ldh',
    ...
    CampusLocation(
      ...
      section: CampusSection.west,
      latitude: 0.0, longitude: 0.0, icon: Icons.sports,
    ),
    CampusLocation(
      id: 'pool',
